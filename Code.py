...
if __name__ == "__main__":
    key = int(input("What would you like to run: baseline(0), greedy(1), hillclimber baseline(2), hillclimber greedy(3), simulated annealing baseline(4), simulated annealing greedy(5), hillclimber random traject(6): "))
