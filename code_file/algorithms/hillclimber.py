    ...
    try:
        ...
        while True:
            ...
            if type_hillclimber == 1:
                ...
                new_model = replace_traject(change_version, max_index, type_base, type_hillclimber)
            ...
            # when the random hillclimber is selected
                ...
                new_model = replace_traject(change_version, random_index, type_base, type_hillclimber)
